    ...
    <>
      <section style={{ position: 'relative', height: '380px', overflow: 'hidden', display: 'flex', alignItems: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '1200px', margin: '0 auto', padding: '0 24px' }}>
          <div style={{ color: '#00AEEF', fontSize: '0.8rem', fontWeight: '700', letterSpacing: '3px', textTransform: 'uppercase', marginBottom: '12px' }}>Join the Team</div>
          <h1 style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: '700', textTransform: 'uppercase', lineHeight: '1.05', color: 'white' }}>
            Careers at<br /><span style={{ color: '#00AEEF' }}>Real Times Cargo</span>
          </h1>
        </div>
      </section>
      ...
      <section style={{ padding: '80px 24px', background: '#F5F7FA' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          {/* No vacancy banner */}
          <div style={{
            background: '#0A1628', borderRadius: '8px', padding: '32px 40px',
            marginBottom: '48px', borderLeft: '4px solid #00AEEF',
            display: 'flex', alignItems: 'center', gap: '20px', textAlign: 'left'
          }}>
            <div style={{ fontSize: '2.5rem', flexShrink: 0 }}>📋</div>
            <div>
              <div style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '1.4rem', fontWeight: '700', color: '#00AEEF', textTransform: 'uppercase', marginBottom: '6px' }}>No Vacancies at the Moment</div>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{
              ...
              <div style={{ color: '#00AEEF', fontSize: '0.9rem', fontWeight: '600', letterSpacing: '1px', textTransform: 'uppercase' }}>No Vacancies Available</div>
            ...
            <div style={{ background: 'white', borderRadius: '8px', padding: '40px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)', textAlign: 'left', filter: 'blur(2px)', pointerEvents: 'none', userSelect: 'none' }}>
              <h3 style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '1.5rem', fontWeight: '700', color: '#0A1628', textTransform: 'uppercase', marginBottom: '8px' }}>Express Your Interest</h3>
              ...
              <button disabled style={{ background: '#0A1628', color: 'white', padding: '12px 32px', borderRadius: '4px', border: 'none', fontWeight: '700', fontSize: '1rem', width: '100%' }}>Submit Application</button>
            </div>
          </div>

          <p style={{ marginTop: '32px', color: '#888', fontSize: '0.9rem' }}>
            Want to reach out directly? Email us at{' '}
            <a href="mailto:info@realtimestc.ae" style={{ color: '#00AEEF', textDecoration: 'none' }}>info@realtimestc.ae</a>
          </p>
        </div>
      </section>
    </>
